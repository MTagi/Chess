...
public class WheelManager : MonoBehaviour
{
    ...
    {
        Debug.Log("Winning item: " + winningItem.itemType.ToString() + winningItem.prefix + winningItem.itemValue + winningItem.affix + "\nTarget angle: " + winningItem.itemObject.transform.localEulerAngles.z);
        if(winningItem.itemType == ITEM_TYPES.Chess)
        {
        ...
        else if(winningItem.itemType == ITEM_TYPES.MandarinSquareCapturing)
        {
             SceneManager.LoadScene("OAnQuanScene");
            // truyền game ô ăn quan
            // Debug.Log("Winning item: " + winningItem.itemType.ToString() + winningItem.prefix + winningItem.itemValue + winningItem.affix + "\nTarget angle: " + winningItem.itemObject.transform.localEulerAngles.z);
        }
        else if(winningItem.itemType == ITEM_TYPES.TicTocToe)
        {
             SceneManager.LoadScene("MainScreen");
            // truyền game caro
            // Debug.Log("Winning item: " + winningItem.itemType.ToString() + winningItem.prefix + winningItem.itemValue + winningItem.affix + "\nTarget angle: " + winningItem.itemObject.transform.localEulerAngles.z);
        }
        else if(winningItem.itemType == ITEM_TYPES.Question)
        {   
            
            //  SceneManager.LoadScene("MainScreen");
            // truyền game trả lời câu hỏi
            // Debug.Log("Winning item: " + winningItem.itemType.ToString() + winningItem.prefix + winningItem.itemValue + winningItem.affix + "\nTarget angle: " + winningItem.itemObject.transform.localEulerAngles.z);
        }
